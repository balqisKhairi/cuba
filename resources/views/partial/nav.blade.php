            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top" style="background: var(--bs-gray-900);box-shadow: 0px 0px rgb(0,0,0);">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <nav></nav><button class="btn btn-primary" type="button" style="background: rgb(255,207,35);color: rgb(0,0,0);font-weight: bold;font-style: italic;font-size: 15px;border-style: none;box-shadow: 0px 0px 10px;">HOME</button>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                                        ...
                                        <a class="dropdown-item d-flex align-items-center" >
                                            ...
                                            <div><span class="small text-gray-500">Today</span>
                                                <p>Check the pending approval for certificates and jobs</p>
                                            </div>
