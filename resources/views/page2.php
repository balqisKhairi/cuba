   ...
   <body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="{{ asset('admin2/assets/img/logo/logo.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-2">
                            <!-- Logo -->
                            <div class="logo">
                                <a href="index.html"><img src="{{ asset('admin2/assets/img/logo/logo.png') }}" alt=""></a>
                            </div>  
                        </div>
                        ...
                        <section class="featured-job-area">
                            <div class="container">
                                ...
                                <div class="single-job-items mb-30">
                                    <div class="job-items">
                                        <div class="company-img">
                                            <a href="#"><img src="{{ asset('admin2/assets/img/icon/job-list1.png') }}" alt=""></a>
                                        </div>
                                ...
                                <div class="single-job-items mb-30">
                                    <div class="job-items">
                                        <div class="company-img">
                                            <a href="#"><img src="{{ asset('admin2/assets/img/icon/job-list2.png') }}" alt=""></a>
                                        </div>
                                        <div class="job-tittle job-tittle2">
                                            <a href="#">
                                                <h4>Digital Marketer</h4>
                                ...
                                <div class="single-job-items mb-30">
                                    <div class="job-items">
                                        <div class="company-img">
                                            <a href="#"><img src="{{ asset('admin2/assets/img/icon/job-list3.png') }}" alt=""></a>
                                        </div>
                                        <div class="job-tittle job-tittle2">
                                            <a href="#">
                                                <h4>Digital Marketer</h4>
                                ...
                                <div class="single-job-items mb-30">
                                    <div class="job-items">
                                        <div class="company-img">
                                            <a href="#"><img src="{{ asset('admin2/assets/img/icon/job-list4.png') }}" alt=""></a>
                                        </div>
                                        <div class="job-tittle job-tittle2">
                                            <a href="#">
                                                <h4>Digital Marketer</h4>
    ...
    <footer>
                          ...
                          <div class="footer-logo mb-20">
                            <a href="index.html"><img src="{{ asset('admin2/assets/img/logo/logo2_footer.png" alt=""></a>
                          </div>
                       </div>
