                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters" style="color: rgb(0,0,0);">
                                        <div class="col me-2">
                                            ...
                                            <div class="row g-0 align-items-center">
                                                <div class="col-auto">
                                                    <div class="text-dark fw-bold h5 mb-0 me-3"><span>{{$notJob}}</span></div>
                                                </div>
                                                <div class="col">
                                                    <div class="progress progress-sm">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="row g-0 align-items-center">
                                                <div class="col-auto">
                                                    <div class="text-dark fw-bold h5 mb-0 me-3"><span>{{$totalStud}}</span></div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters" style="color: rgb(0,0,0);">
                                        <div class="col me-2">
                                            ...
                                            <div class="row g-0 align-items-center">
                                                <div class="col-auto">
                                                    <div class="text-dark fw-bold h5 mb-0 me-3"><span>{{ $totalEmplo}}</span></div>
                                                </div>
                                            </div>
                                        </div>
